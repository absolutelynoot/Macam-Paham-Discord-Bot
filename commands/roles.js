module.exports = {
    ...
    execute(message, args, Discord){
        ...
        .addFields(
            ...
            {name: 'Paham (Understand) - Default Rank', value: '- Access to server text and voice chats' },
            {name: 'Kurang Paham (Somewhat Understand) - Active Players', value: '- All the benefits of Paham +\n- Unlock access to #👑private-paham  chat room\n- Unlock access to private voice chat rooms\n- Unlock access to **Music Bot ** controlled through ** music **channel `type "$help" for help)`' },
            {name: "Tak Paham (Don't Understand) - Frequent players", value: '- All the benefits from Kurang Paham+\n- Unlock the ability to mute and deafen other members\n- Unlock the ability to move other members'},
            {name: '\u200B', value: '\u200B' },

module.exports = {
    ...
    execute(message, args, Discord){
        ...
        .addFields(
            {name: 'Origin', value: "For those who didn't know, the word 'Macam Paham' is a Malay phrase and a common Singaporean Slang which directly translates to 'like you know it all'."},
            {name: 'Server Rules', value: 'type `!rules` to see the server rules'},
            {name: 'Role and Rewards', value: 'type `!roles` to see the server roles and rewards' },
            {name: '\u200B', value: '\u200B' },
            {name: 'Moderator', value: '@Fariz-#3355', inline: true},
            {name: 'Facebook Page', value: '[click here](https://www.facebook.com/Macam-Paham-101813258514341/?notif_id=1608820549422324&notif_t=page_invite_accept&ref=notif)', inline: true},
    ...
    execute(message, args, Discord){
        const newEmbed = new Discord.MessageEmbed()
        .setColor('#F3CD98')
        .setTitle('Macam Paham Server Rules!')
        .setThumbnail('https://scontent.fsin9-1.fna.fbcdn.net/v/t1.0-9/132798110_101959391833061_3898216952922430083_n.jpg?_nc_cat=111&ccb=2&_nc_sid=730e14&_nc_ohc=eb8KfxrJ_wsAX-Hws_l&_nc_oc=AQmcmiJmmEK8UOBd3h6rZA-Ze77Er5rDtHjslq5160-e9E1ShVgTN4jVYg2H0lK8hqw&_nc_ht=scontent.fsin9-1.fna&oh=86dbc7d388a41a0ae65f471e48f50031&oe=6008F5D1')
        .addFields(
            {name: 'Origin', value: "For those who didn't know, the word 'Macam Paham' is a Malay phrase and a common Singaporean Slang which directly translates to 'like you know it all'."},
            ...
            {name: 'Role and Rewards', value: 'click here' },
            {name: '\u200B', value: '\u200B' },
            {name: 'Moderator', value: `<@Fariz-#3355>`, inline: true},
